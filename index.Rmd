...
******
- メモ
  + [Rの使い方](https://takeshinishimura.github.io/howtouseR)
  + [卒業論文の書き方](https://takeshinishimura.github.io/howtowrite)
  + [農業簿記の基礎（TeX製PDF）](https://researchmap.jp/takeshinishimura/social_contribution/31833947)
  + [Excel VBAの基礎（TeX製PDF）](https://researchmap.jp/takeshinishimura/social_contribution/31833980)
...
m %>% leaflet::setView(lng = 133.935, lat = 34.66167, zoom = 9) %>%
  leaflet::addPopups(lng = 133.935, lat = 34.66167, popup = "Okayama, Japan") %>%
