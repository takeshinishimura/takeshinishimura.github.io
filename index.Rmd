...
- iPad Air (4th generation) <- iPadOS 14
- iPad Pro (9.7-inch) (iPad6,4) <- iPadOS 14
- iPad mini 3 (iPad4,7) <- iPadOS 12.5
- iPad Air (iPad4,1) <- iPadOS 12.5
- The new iPad (iPad3,1) <- iOS 9.3.5
- iPad mini (iPad2,5) <- iOS 9.3.5
- iPad 2 (iPad2,1) <- iOS 6.1.3
- iPad (iPad1,1) <- iOS 5.1.1
